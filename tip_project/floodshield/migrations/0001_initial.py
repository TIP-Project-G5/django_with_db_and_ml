# Generated by Django 4.0.2 on 2024-05-04 08:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dp_phone_no', models.TextField()),
                ('dp_mobile_no', models.TextField()),
                ('dp_area_id', models.ForeignKey(db_column='dp_area_id', on_delete=django.db.models.deletion.CASCADE, to='floodshield.area')),
            ],
            options={
                'db_table': 'DEPOT',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rainfall_value', models.DecimalField(decimal_places=2, max_digits=10)),
                ('rf_area_id', models.ForeignKey(db_column='area_id', on_delete=django.db.models.deletion.CASCADE, to='floodshield.area')),
            ],
            options={
                'db_table': 'RAINFALL',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_area_id', models.ForeignKey(db_column='area_id', on_delete=django.db.models.deletion.CASCADE, to='floodshield.area')),
            ],
            options={
                'db_table': 'PREDICTION',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gw_depot_no', models.ForeignKey(db_column='gw_depot_no', on_delete=django.db.models.deletion.CASCADE, to='floodshield.depot')),
            ],
            options={
